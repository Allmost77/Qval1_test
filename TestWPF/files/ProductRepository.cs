...
namespace TestWPF.files
{
    ...
    public static class ProductRepository
    {
        ...
        private static string connectionString = "Data Source=localhost\\SQLEXPRESS01;Database=MyBD;Integrated Security=True;Pooling=False;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Command Timeout=0";
