...
namespace TestWPF.files
{
    static class Db
    {
        public static string S(IDataRecord r, string col) => r[col] == DBNull.Value ? "" : r[col].ToString() ?? "";
        public static int I(IDataRecord r, string col) => r[col] == DBNull.Value ? 0 : System.Convert.ToInt32(r[col]);
    }
    public static class ProductRepository
    {
        ...
        public static int UpdateProduct(int id, string article, string name, string description, decimal price, int quantity, int discount,
